...
export const Contact = ({ alert }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    let response = await fetch("https://formsubmit.co/ajax/prajjwalsharma.bpl@gmail.com", {
      method: "POST",
      headers: {
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    {/* {
                      status.message &&
                      <Col>
                        <p className={status.success === false ? "danger" : "success"}><strong>{status.message}</strong></p>
                      </Col>
                    } */}
                  </Row>
                </form>
